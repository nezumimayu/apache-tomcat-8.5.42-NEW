...
public class NioEndpoint extends AbstractJsseEndpoint<NioChannel> {
    ...
    public void bind() throws Exception {
        ...
        if (!getUseInheritedChannel()) {
            ...
            serverSock.socket().bind(addr,getAcceptCount());                                            //启动源码32：绑定对应的端口号进行监听
        } else {
    ...
    public void startInternal() throws Exception {
        ...
        if (!running) {
            ...
            startAcceptorThreads();                                                     //启动源码47：开启接收请求的线程
        }
    }
    ...
    protected AbstractEndpoint.Acceptor createAcceptor() {
        return new Acceptor();                                          //启动源码51：返回新创建的Acceptor对象
    }
    ...
    protected class Acceptor extends AbstractEndpoint.Acceptor {
        ...
        @Override
        public void run() {                                             //启动源码52：Acceptor具体实现的run()
            ...
            while (running) {
                ...
                try {
                    ...
                    try {
                        ...
                        // socket
                        socket = serverSock.accept();                                       //启动源码53：通过serverSocket调用accept()接收客户端请求（重点）
