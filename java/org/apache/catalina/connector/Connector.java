...
public class Connector extends LifecycleMBeanBase  {
    ...
    protected void initInternal() throws LifecycleException {
        ...
        // Initialize adapter
        adapter = new CoyoteAdapter(this);                  //启动源码24：创建一个CoyoteAdapter对象
        protocolHandler.setAdapter(adapter);                          //启动源码25：把adapter设置到protocolHandler中
        ...
        try {
            protocolHandler.init();                                     //启动源码26：初始化protocolHandler
        } catch (Exception e) {
    ...
    protected void startInternal() throws LifecycleException {
        ...
        try {
            protocolHandler.start();                                        //启动源码42：调用protocolHandler.start()
        } catch (Exception e) {
            throw new LifecycleException(
