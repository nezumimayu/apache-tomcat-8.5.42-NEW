...
public class Catalina {
     ...
     */
    protected Digester createStartDigester() {                              //启动源码14：the main digester to parse server.xml
    ...
    public void load() {
        ...
        initDirs();                                     //启动源码11：初始化目录

        // Before digester - it may be needed
        initNaming();                                   //启动源码12：初始化命名信息

        // Create and execute our Digester
        Digester digester = createStartDigester();      //启动源码13：创建Digester进行XML文件解析（Digester是Tomcat的XML文件解析工具）
        ...
        try {
            getServer().init();                                                 //启动源码15：获取Server并进行初始化
        } catch (LifecycleException e) {
    ...
    public void start() {
        ...
        // Start the new server
        try {
            getServer().start();                                                //启动源码34：获取server并调用start()
        } catch (LifecycleException e) {
